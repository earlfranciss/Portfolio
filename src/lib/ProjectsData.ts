...
export const ProjectData: Project[] = [
  {
    ...
    images: [
      "/assets/SwiftShield/Login.webp",
      "/assets/SwiftShield/Register.webp",
      "/assets/SwiftShield/HomePage.webp",
      "/assets/SwiftShield/Analytics.webp",
      "/assets/SwiftShield/LogDetails.webp",
      "/assets/SwiftShield/LockScreen.webp",
      "/assets/SwiftShield/AccessRestriction.webp",
      "/assets/SwiftShield/In-AppRestrictAccess.webp",
    ],
    techStack: [
  ...
  },
  {
    ...
    images: [
      "/assets/ProductivIO/Tasks.webp",
      "/assets/ProductivIO/Login.webp",
      "/assets/ProductivIO/Register.webp",
      "/assets/ProductivIO/LandingPage.webp",
      "/assets/ProductivIO/Notes.webp",
      "/assets/ProductivIO/Flashcard.webp",
      "/assets/ProductivIO/Study.webp",
      "/assets/ProductivIO/Quiz.webp",
      "/assets/ProductivIO/Pomodoro.webp",
    ],
    techStack: [
  ...
  },
  {
    ...
    images: [
      "/assets/HRConnect/LandingPage.webp",
      "/assets/HRConnect/Login.webp",
      "/assets/HRConnect/Register.webp",
      "/assets/HRConnect/Dashboard.webp",
      "/assets/HRConnect/WidgetNewChat.webp",
      "/assets/HRConnect/WidgetOpenChat.webp",
      "/assets/HRConnect/FullScreenNewChat.webp",
      "/assets/HRConnect/FullScreenOpenChat.webp",
    ],
    techStack: [
