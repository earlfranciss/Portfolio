...
export default function Footer() {
  ...
  return (
    <footer className="relative flex flex-col items-center pt-6 p-4 text-sm text-gray-400 justify-between mt-9">
      ...
      <div className="w-full text-xs sm:text-sm grid grid-cols-3 items-center max-w-5xl">
        <div className="justify-self-start">
          Earl Francis - © 2025
        </div>

        <div className="italic text-sm text-center justify-self-center">
          Sic Parvis Magna
        </div>
                ...
                onValueChange={(value) => {
                  ...
                  if (value === "v1") {
                    window.location.href =
                      "https://earlfranciss.github.io/Portfolio-Old/";
                  } else {
                    router.push("/");
                  }
                }}
